...
namespace meanran_xuexi_mods_xiaoyouhua
{
    ...
    {
        public static void 拧螺丝(this PowerTransmitter 微波输电发射器, Interactable 微波输电发射器控件, 通用可选择项目 已选择)
        {
            switch (已选择.解包标志)
            {
                case 通用可选择项目.数据解包标志.物联网已上线设备:
                    switch (微波输电发射器控件.Action)
                    {
                        ...
                        case InteractableType.Button4:
                            拧螺丝(微波输电发射器, 已选择.链接物体);
                            微波输电装置数据包.发送数据包(微波输电发射器.ReferenceId, 已选择.链接物体.ReferenceId, 微波输电发射器控件.InteractableId, 通用可选择项目.数据解包标志.物联网已上线设备);
                            break;
                        default: break;
                    }
                    break;
        ...
        public static 通用可选择项目 生成消息(this PowerTransmitter 微波输电发射器, Interactable 微波输电发射器控件)
        {
            通用可选择项目 包 = new();
            ...
            switch (微波输电发射器控件.Action)
            {
                ...
                case InteractableType.Button4:
                    ...
                    包.物联网已上线设备表或内部储物表或试剂引用 = Transmitters.AllTransmitters?.Where(d => d != (ILogicable)微波输电发射器 && (d is PowerReceiver));
