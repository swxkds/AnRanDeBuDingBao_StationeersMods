...
namespace meanran_xuexi_mods_xiaoyouhua
{
    ...
    {
        public static void 拧螺丝(this LogicGate 逻辑门, Interactable 逻辑门控件, 可选择项目 已选择项目)
        {
            switch (已选择项目.数据包.包头)
            {
                case 数据包.数据解包标志.物联网已上线设备:
                    switch (逻辑门控件.Action)
                    {
                        case InteractableType.Button1: 拧螺丝一(逻辑门, 已选择项目.数据包.链接物体); break;
                        case InteractableType.Button2: 拧螺丝二(逻辑门, 已选择项目.数据包.链接物体); break;
                        default: break;
                    }
                    break;
                case 数据包.数据解包标志.逻辑门运算符:
                    switch (逻辑门控件.Action)
                    {
                        case InteractableType.Button3: 拧螺丝三(逻辑门, (GateOperators)已选择项目.数据包.操作数["参数"]); break;
                        default: break;
                    }
                    break;
                default: break;
        ...
        {
            // TODO:联机游戏请在此处发送数据包
            逻辑门.Input1 = (LogicUnitBase)已选择;
            逻辑门.Setting = 0;
        }
        private static void 拧螺丝二(LogicGate 逻辑门, Thing 已选择)
        {
            // TODO:联机游戏请在此处发送数据包
            逻辑门.Input2 = (LogicUnitBase)已选择;
            逻辑门.Setting = 0;
        }
        ...
        public static 数据包 生成消息(this LogicGate 逻辑门, Interactable 逻辑门控件)
        {
            数据包 包 = new();
            // 包.链接物体 = 逻辑门.Input1;
            ...
            switch (逻辑门控件.Action)
            {
                case InteractableType.Button1:
                    ...
                    包.物联网已上线设备表或试剂引用 = 逻辑门.InputNetwork1DevicesSorted?.Where(d => d != (ILogicable)逻辑门 && d is LogicUnitBase && d.IsLogicReadable());
                ...
                case InteractableType.Button2:
                    包.包头 = 数据包.数据解包标志.有线网已上线设备;
                    包.物联网已上线设备表或试剂引用 = 逻辑门.InputNetwork2DevicesSorted?.Where(d => d != (ILogicable)逻辑门 && d is LogicUnitBase && d.IsLogicReadable());
                    if (包.物联网已上线设备表或试剂引用 == null)
                    { 包.操作数["在线设备数"] = -1; }
                    else { 包.操作数["在线设备数"] = ((IEnumerable<ILogicable>)包.物联网已上线设备表或试剂引用).Count(); }
                    break;
                case InteractableType.Button3:
                    包.包头 = 数据包.数据解包标志.逻辑门运算符;
                    break;
                default:
                    包.包头 = 数据包.数据解包标志.未知;
                    break;
