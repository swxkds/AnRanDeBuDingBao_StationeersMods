...
namespace meanran_xuexi_mods_xiaoyouhua
{
    public class 功能模块之立体文字装饰_资源加载器
    {
        ...
        public Dictionary<string, (Mesh 已合并Mesh, Material[] 所有subMesh材质)> 所有多边形网格与材质 { get; private set; }
        ...
        public 功能模块之立体文字装饰_资源加载器()
        {
            ...
            所有多边形网格与材质 = new Dictionary<string, (Mesh 已合并Mesh, Material[] 所有subMesh材质)>();
